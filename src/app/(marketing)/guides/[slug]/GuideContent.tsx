      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
        {links.map((link) => (
          <Link
            key={link.href}
            href={link.href}
            className="flex items-center gap-3 p-3 rounded-xl group transition-all duration-200 hover:bg-[rgba(255, 168, 51,0.06)]"
            style={{
          ...
          <div className="max-w-6xl mx-auto flex gap-10">
            ...
            <aside className="hidden lg:block w-64 shrink-0">
              <div className="sticky top-28">
                ...
                <div className="mt-6 pt-6" style={{ borderTop: '1px solid rgba(255, 136, 0, 0.15)' }}>
