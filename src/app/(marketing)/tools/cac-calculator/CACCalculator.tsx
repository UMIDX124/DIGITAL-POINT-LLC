...
export function CACCalculator({ faqs }: Props) {
  ...
  const ratioColor = ltvCacRatio >= 5 ? '#a3e635' : ltvCacRatio >= 3 ? '#6366F1' : ltvCacRatio >= 1 ? '#818CF8' : '#6366F1';
        ...
        <Container className="relative z-10 pt-28 pb-8">
          <FadeUp>
            ...
            <h1 className="font-display text-3xl md:text-4xl lg:text-5xl font-bold text-white leading-tight mt-6">
              CAC{' '}
              <span className="bg-gradient-to-r from-[#6366F1] via-[#6366F1] to-[#818CF8] bg-clip-text text-transparent">Calculator</span>
            </h1>
            ...
            <FadeUp delay={0.1}>
              <GlassCard className="p-6 md:p-8">
                <div className="flex items-center justify-between mb-6">
                  ...
                  <button onClick={handleShare} className="p-2 rounded-lg text-[#71717A] hover:text-[#6366F1] transition-colors" style={{ background: 'rgba(99,102,241, 0.1)' }}>
                ...
                <div className="space-y-4">
                  <div className="rounded-xl p-4" style={{ background: 'rgba(13, 8, 21, 0.5)', border: '1px solid rgba(99,102,241, 0.15)' }}>
                    ...
                    <p className="font-display text-3xl font-bold text-[#6366F1] mt-1">
                      {cac > 0 ? `$${cac.toFixed(0)}` : '—'}
                    </p>
                  </div>
                    ...
                    <table className="w-full text-sm">
                      <thead>
                        <tr style={{ background: 'rgba(99,102,241, 0.1)' }}>
                          ...
                          <th className="text-right px-4 py-3 text-[#6366F1] font-medium">Avg CAC</th>
                          <th className="text-right px-4 py-3 text-[#6366F1] font-medium">Avg LTV:CAC</th>
                        </tr>
                      </thead>
