...
export function CACCalculator({ faqs }: Props) {
  ...
  const ratioColor = ltvCacRatio >= 5 ? '#a3e635' : ltvCacRatio >= 3 ? '#F59E0B' : ltvCacRatio >= 1 ? '#fbbf24' : '#F59E0B';
        ...
        <Container className="relative z-10 pt-28 pb-8">
          <FadeUp>
            ...
            <h1 className="font-display text-3xl md:text-4xl lg:text-5xl font-bold text-white leading-tight mt-6">
              CAC{' '}
              <span className="bg-gradient-to-r from-[#F59E0B] via-[#F59E0B] to-[#FBBF24] bg-clip-text text-transparent">Calculator</span>
            </h1>
            ...
            <FadeUp delay={0.1}>
              <GlassCard className="p-6 md:p-8">
                <div className="flex items-center justify-between mb-6">
                  ...
                  <button onClick={handleShare} className="p-2 rounded-lg text-[#71717A] hover:text-[#F59E0B] transition-colors" style={{ background: 'rgba(217,119,6, 0.1)' }}>
                ...
                <div className="space-y-4">
                  <div className="rounded-xl p-4" style={{ background: 'rgba(13, 8, 21, 0.5)', border: '1px solid rgba(217,119,6, 0.15)' }}>
                    ...
                    <p className="font-display text-3xl font-bold text-[#F59E0B] mt-1">
                      {cac > 0 ? `$${cac.toFixed(0)}` : '—'}
                    </p>
                  </div>
            ...
            <FadeUp>
              <div className="space-y-8">
                ...
                <div>
                  ...
                  <div className="rounded-xl overflow-hidden" style={{ border: '1px solid rgba(217,119,6, 0.15)' }}>
                    <table className="w-full text-sm">
                      <thead>
                        <tr style={{ background: 'rgba(217,119,6, 0.1)' }}>
                          <th className="text-left px-4 py-3 text-[#F59E0B] font-medium">Industry</th>
                          <th className="text-right px-4 py-3 text-[#F59E0B] font-medium">Avg CAC</th>
                          <th className="text-right px-4 py-3 text-[#F59E0B] font-medium">Avg LTV:CAC</th>
                        </tr>
                      </thead>
