...
faqs:
  ...
  - question: "How should I split budget between brand and performance?"
    answer: "Research from Les Binet and Peter Field suggests a 60/40 split favoring brand for established businesses. For growth-stage companies, 70/30 favoring performance is common. The optimal split depends on your growth stage, category maturity, and brand awareness levels."
  - question: "Can brand marketing be measured like performance marketing?"
    answer: "Not with the same precision, but it can be measured. Brand lift studies, share of voice tracking, branded search volume trends, direct traffic growth, and marketing mix modeling all quantify brand impact. The measurement timeline is longer (quarters vs. days) but the data is actionable."
  - question: "What happens if I only invest in performance marketing?"
    answer: "Short-term results look good, but long-term efficiency degrades. Without brand investment, CAC rises over time as you exhaust high-intent audiences, ad costs increase without brand preference to lower them, and you become dependent on paid channels with no organic demand floor."
---
...
People actively searching for a solution. They know they have a problem and are evaluating options. [Performance marketing](/performance-marketing) captures this demand through search ads, retargeting, and conversion-optimized campaigns.
...
**For established businesses:** 60% brand / 40% performance (activation)
**For online-only businesses:** 58% brand / 42% performance
**For businesses with long sales cycles:** 72% brand / 28% performance

**Why brand gets the majority:** Brand effects compound over time while performance effects are temporary. A brand campaign creates value that lasts months to years. A performance campaign only creates value while money is being spent.
...
- [ROAS declining](/blog/why-your-roas-is-lying) as you scale spend
...
- [Podcast advertising](/blog/podcast-advertising-guide) and podcast creation
...
[Connected TV advertising](/blog/connected-tv-advertising-guide) brings brand-building television advertising to digital marketers with measurement capabilities:
...
- Can be measured alongside [performance campaigns](/blog/cross-channel-attribution)
...
[Google Search ads](/blog/google-search-ads-optimization) remain the highest-intent channel:

- Non-branded search for category demand capture
- Branded search protection (competitors will bid on your name)
- [Shopping ads](/blog/shopping-ads-optimization) for e-commerce

### Retargeting

[Retargeting](/blog/retargeting-strategy-guide) converts brand-aware visitors into customers:
...
- Lead generation campaigns on [Meta](/blog/meta-ads-strategy-guide) and [LinkedIn](/blog/linkedin-ads-guide-b2b)
- Collection and shopping ads for e-commerce
- App install campaigns on [TikTok](/blog/tiktok-ads-guide-2026)

### [Landing page optimization](/blog/landing-page-optimization-paid-ads)
...
[Marketing mix modeling (MMM)](/blog/marketing-mix-modeling) is the gold standard for measuring brand's contribution to revenue. MMM uses statistical analysis to determine the causal impact of brand spending on total revenue, accounting for seasonality, competitive activity, and other variables.
...
Build [dashboards](/blog/marketing-dashboard-kpis) that show brand metrics alongside performance metrics. When leadership sees branded search volume rising alongside improving CAC, the case for brand investment becomes self-evident.
...
- Use [incrementality testing](/blog/incrementality-testing-guide) methodology

The [Performance Marketing](/performance-marketing) and [Systems & Reporting](/systems-reporting) teams at Digital Point LLC help companies find the right balance between brand and performance marketing based on data, not opinions.
