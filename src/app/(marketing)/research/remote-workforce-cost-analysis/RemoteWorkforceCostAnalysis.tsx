                ...
                <table className="w-full text-sm">
                  ...
                  <tbody>
                    {roleCostComparison.map((row, i) => (
                      <tr key={row.role} className={i < roleCostComparison.length - 1 ? 'border-b border-[rgba(167,139,250,0.08)]' : ''}>
                ...
                <table className="w-full text-sm">
                  ...
                  <tbody>
                    {usOverheadBreakdown.map((row, i) => (
                      <tr key={row.item} className={i < usOverheadBreakdown.length - 1 ? 'border-b border-[rgba(167,139,250,0.08)]' : ''}>
                ...
                <table className="w-full text-sm">
                  ...
                  <tbody>
                    {teamScaleComparison.map((row, i) => (
                      <tr key={row.teamSize} className={i < teamScaleComparison.length - 1 ? 'border-b border-[rgba(167,139,250,0.08)]' : ''}>
                ...
                <table className="w-full text-sm">
                  ...
                  <tbody>
                    {qualityMetrics.map((row, i) => (
                      <tr key={row.metric} className={i < qualityMetrics.length - 1 ? 'border-b border-[rgba(167,139,250,0.08)]' : ''}>
