        ...
        <Container className="relative z-10 pt-28 pb-8">
          <FadeUp>
            ...
            <h1 className="font-display text-3xl md:text-4xl lg:text-5xl font-bold text-white leading-tight mt-6">
              Ad Spend{' '}
              <span className="bg-gradient-to-r from-[#a3e635] via-[#F59E0B] to-[#FBBF24] bg-clip-text text-transparent">Profit</span>
              {' '}Calculator
            </h1>
            ...
            <FadeUp>
              <GlassCard className="p-6 md:p-8">
                ...
                <div className="space-y-5">
                  ...
                  <div>
                    <label className="block text-sm text-[#D6D0C2] mb-1.5">Overhead (% of revenue) <span className="text-[#71717A]">optional</span></label>
                    <div className="relative">
                      <Percent className="absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4 text-[#71717A]" />
                ...
                <div className="space-y-4">
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    <div className="rounded-xl p-4" style={{ background: 'rgba(13, 8, 21, 0.5)', border: '1px solid rgba(217,119,6, 0.15)' }}>
                      ...
                      <p className={`font-display text-xl font-bold mt-1 ${profitMargin >= 0 ? 'text-[#F59E0B]' : 'text-[#F59E0B]'}`}>
                        {revenue > 0 ? `${profitMargin.toFixed(1)}%` : '—'}
                      </p>
                    </div>
                    <div className="rounded-xl p-4" style={{ background: 'rgba(13, 8, 21, 0.5)', border: '1px solid rgba(217,119,6, 0.15)' }}>
                      <span className="text-[#71717A] text-xs">Annual Profit</span>
                      <p className={`font-display text-xl font-bold mt-1 ${annualProfit >= 0 ? 'text-[#a3e635]' : 'text-[#F59E0B]'}`}>
                      ...
                      <div className="space-y-2">
                        {scenarios.map((s) => (
                          <div key={s.label} className="flex items-center justify-between text-xs">
                            ...
                            <span className={`font-mono ${s.profit >= 0 ? 'text-[#a3e635]' : 'text-[#F59E0B]'}`}>
