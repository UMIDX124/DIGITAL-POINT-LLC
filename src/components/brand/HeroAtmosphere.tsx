...
export function HeroAtmosphere({ variant = 'home', className }: Props) {
  ...
  return (
    ...
    >
      ...
      {variant === 'home' && (
        <g opacity="0.18">
          <rect x="1180" y="80" width="80" height="80" fill="none" stroke="var(--color-accent)" strokeWidth="1.5" />
          <rect x="1260" y="120" width="60" height="60" fill="none" stroke="var(--color-accent)" strokeWidth="1.5" />
          <rect x="1200" y="180" width="40" height="40" fill="none" stroke="var(--color-accent)" strokeWidth="1.5" />
          <rect x="1260" y="200" width="28" height="28" fill="var(--color-accent)" />
        </g>
      )}

      {variant === 'pillar' && (
        <g opacity="0.2">
          <rect x="1240" y="80" width="3" height="160" fill="var(--color-accent)" />
          <rect x="1264" y="120" width="3" height="220" fill="var(--color-accent)" opacity="0.7" />
          <rect x="1288" y="60" width="3" height="280" fill="var(--color-accent)" opacity="0.5" />
          <rect x="1312" y="100" width="3" height="200" fill="var(--color-accent)" opacity="0.35" />
        </g>
      )}
    </svg>
  );
