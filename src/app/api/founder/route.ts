      ...
      await sendEmail({
        ...
        html: `
          <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; background: #0A0A0B; color: #F5F1E8; padding: 32px; border-radius: 12px;">
            <h2 style="color: #6366F1; margin-top: 0;">New Founder Contact</h2>
            <table style="width: 100%; border-collapse: collapse;">
              <tr><td style="padding: 8px 0; color: #D6D0C2;">Name</td><td style="padding: 8px 0; color: #F5F1E8;">${escapeHtml(name)}</td></tr>
              <tr><td style="padding: 8px 0; color: #D6D0C2;">Email</td><td style="padding: 8px 0;"><a href="mailto:${escapeHtml(email)}" style="color: #6366F1;">${escapeHtml(email)}</a></td></tr>
            </table>
            <div style="margin-top: 16px; padding: 16px; background: rgba(20,20,22,0.8); border-radius: 8px; border: 1px solid rgba(99,102,241,0.2);">
